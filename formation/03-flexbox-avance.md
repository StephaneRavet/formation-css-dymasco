...
État attendu de `overrides.css` après le Module 3 (~250 lignes). Démontre flexbox avancé : header en flexbox avec ellipsis, min-width:0 sur les ancêtres, gap, alignements. Voir [projet-fil-rouge/checkpoints/03-flexbox/overrides.css](../projet-fil-rouge/checkpoints/03-flexbox/overrides.css).
